...
public class Aplicacion extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Recogida fecha javafx
        DatePicker datePicker = new DatePicker();
        grid.add(datePicker, 1, 3);
        
        Button fechaButton = new Button("Guardar con fecha");
        grid.add(fechaButton, 1, 4);
        
		fechaButton.setOnAction(e -> {
			System.out.println(datePicker.getValue());
			almacenarDatos(userTextField.getText(), passwordField.getText(), datePicker.getValue());
		});
